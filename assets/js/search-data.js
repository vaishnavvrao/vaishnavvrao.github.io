...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-passed-the-dept-of-astronomy-prelim-exam-officially-a-phd-candidate-now",
          title: 'Passed the Dept. of Astronomy prelim exam! Officially a PhD candidate now.',
          description: "",
          section: "News",},{id: "projects-stars-born-in-the-wind",
          title: 'Stars Born in the Wind',
          description: "The Story of M82&#39;s Southern Arcs",
          section: "Projects",handler: () => {
              window.location.href = "/projects/m82_southern_arcs/";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%76%76%72%61%6F@%75%6D%69%63%68.%65%64%75", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=1Fii5rQAAAAJ&hl=en", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://ui.adsabs.harvard.edu/public-libraries/HgwP8izxSneIPkMGWNRxJg", "_blank");
        },
      },{
      id: 'light-theme',
